    ...
    <main id="top" className="min-h-[100svh] bg-[var(--bg)] text-[var(--text)]">
        ...
        <Container>
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <ul className="mt-3 grid gap-2 text-[var(--subtle)]">
              <li><span className="font-semibold text-[var(--text)]">— Overwhelming amount of information</span> on any given file</li>
              <li><span className="font-semibold text-[var(--text)]">— Limited time</span> to familiarize on a new topic or country context</li>
              <li><span className="font-semibold text-[var(--text)]">— Lack of tools</span> that consolidate authoritative information generated by the UN</li>
            </ul>
          </div>
      ...
      <Section id="product" className="scroll-mt-24">
        <Container>
          ...
          <div className="mt-8">
            <h2 className="text-3xl font-semibold">REGIA is a modular and scalable tool built for UN experts by UN experts:</h2>
          </div>
      ...
      <Section id="product-roadmap" className="scroll-mt-24">
        <Container>
          <div className="mb-6 max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold">From prototype to production scale</h2>
          </div>
